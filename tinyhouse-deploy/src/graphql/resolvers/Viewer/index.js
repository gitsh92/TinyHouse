...
const logInViaGoogle = (code, token, db, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const userName = (_c = (_b = (_a = user.names) === null || _a === void 0 ? void 0 : _a.at(0)) === null || _b === void 0 ? void 0 : _b.displayName) !== null && _c !== void 0 ? _c : null;
    const userId = (_h = (_g = (_f = (_e = (_d = user.names) === null || _d === void 0 ? void 0 : _d.at(0)) === null || _e === void 0 ? void 0 : _e.metadata) === null || _f === void 0 ? void 0 : _f.source) === null || _g === void 0 ? void 0 : _g.id) !== null && _h !== void 0 ? _h : null;
    const userAvatar = (_l = (_k = (_j = user.photos) === null || _j === void 0 ? void 0 : _j.at(0)) === null || _k === void 0 ? void 0 : _k.url) !== null && _l !== void 0 ? _l : null;
    const userEmail = (_p = (_o = (_m = user.emailAddresses) === null || _m === void 0 ? void 0 : _m.at(0)) === null || _o === void 0 ? void 0 : _o.value) !== null && _p !== void 0 ? _p : null;
    ...
    if (!viewer) {
        ...
        viewer = yield db.users.findOne({ _id: userId });
    }
