...
exports.listingResolvers = {
    Query: {
        listing: (_root, { id }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                const listing = yield db.listings.findOne({ _id: new bson_1.ObjectId(id) });
                if (!listing) {
    ...
    Mutation: {
        hostListing: (_root, { input }, { db, req }) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const insertId = new bson_1.ObjectId();
            const insertResult = yield db.listings.insertOne(Object.assign(Object.assign({ _id: insertId }, input), { image: imageUrl, bookings: [], bookingsIndex: {}, country,
                admin,
